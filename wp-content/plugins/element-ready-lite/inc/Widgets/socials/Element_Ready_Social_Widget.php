...
class Element_Ready_Social_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Social Buttons', 'element-ready' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'social_media_sheres',
            [
                'label' => esc_html__( 'Social Shere', 'element-ready' ),
            ]
        );
            $this->add_control(
                'social_view',
                [
                    'label'       => esc_html__( 'Social Icon Style', 'element-ready' ),
            ...
            $repeater->start_controls_tabs('social_content_area_tabs');
                ...
                $repeater->start_controls_tab(
                    ...
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'default' => esc_html__( 'Twitter', 'element-ready' ),
                        ]
                    );
                ...
                $repeater->start_controls_tab(
                    ...
                    [
                        'label' => esc_html__( 'Icon Style', 'element-ready' ),
                    ]
                );
                    $repeater->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            ...
                            'element_ready_social_title' => esc_html__( 'Twitter', 'element-ready' ),
                        ],
                    ],
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'icon_height',
                [
                    'label'      => esc_html__( 'Icon Height', 'element-ready' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => [ 'px' ],
                    'range'      => [
                        'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Social Item', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->start_controls_tabs( 'social_button_tabs_style' );
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'   => esc_html__( 'Link Display', 'element-ready' ),
                            'type'    => Controls_Manager::SELECT,          
                            'options' => [
                                'initial'      => esc_html__( 'Initial', 'element-ready' ),
                                'block'        => esc_html__( 'Block', 'element-ready' ),
