...
class WooCommerce_Free_Download extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'ER Woo Free Download', 'element-ready' );
	}
	...
	public static function button_layout(){
		return [
			'btn__layout__1'      => esc_html__('Button Style 1','element-ready'),
			'btn__layout__2'      => esc_html__('Button Style 2','element-ready'),
			'btn__layout__custom' => esc_html__('Custom Style','element-ready'),
		];
	}

	static function button_effect(){
		return [
			'ripple__btn'         => esc_html__('Ripple Effect','element-ready'),
			'btn__effect__1'      => esc_html__('Effect 1','element-ready'),
			'btn__effect__2'      => esc_html__('Effect 2','element-ready'),
			'btn__effect__3'      => esc_html__('Effect 3','element-ready'),
			'btn__effect__4'      => esc_html__('Effect 4','element-ready'),
			'btn__effect__5'      => esc_html__('Effect 5','element-ready'),
			'btn__effect__6'      => esc_html__('Effect 6','element-ready'),
			'btn__effect__7'      => esc_html__('Effect 7','element-ready'),
			'btn__effect__8'      => esc_html__('Effect 8','element-ready'),
			'btn__effect__9'      => esc_html__('Effect 9','element-ready'),
			'btn__effect__10'     => esc_html__('Effect 10','element-ready'),
			'btn__effect__11'     => esc_html__('Effect 11','element-ready'),
			'btn__effect__12'     => esc_html__('Effect 12','element-ready'),
			'btn__effect__13'     => esc_html__('Effect 13','element-ready'),
			'btn__effect__14'     => esc_html__('Effect 14','element-ready'),
			'btn__effect__15'     => esc_html__('Effect 15','element-ready'),
			'btn__effect__16'     => esc_html__('Effect 16','element-ready'),
			'btn__effect__17'     => esc_html__('Effect 17','element-ready'),
			'btn__effect__18'     => esc_html__('Effect 18','element-ready'),
			'btn__effect__19'     => esc_html__('Effect 19','element-ready'),
			'btn__effect__20'     => esc_html__('Effect 20','element-ready'),
			'btn__effect__21'     => esc_html__('Effect 21','element-ready'),
			'btn__effect__22'     => esc_html__('Effect 22','element-ready'),
			'btn__effect__23'     => esc_html__('Effect 23','element-ready'),
			'btn__effect__24'     => esc_html__('Effect 24','element-ready'),
			'btn__custom__effect' => esc_html__('Custom Effect','element-ready'),
		];
	}

	static function button_text_effect(){
		return [
			'btn__notext__effect' => esc_html__( 'No Effect', 'element-ready'),
			'btn__texteffect__1'  => esc_html__( 'Text Effect 1', 'element-ready'),
			'btn__texteffect__2'  => esc_html__( 'Text Effect 2', 'element-ready'),
			'btn__texteffect__3'  => esc_html__( 'Text Effect 3', 'element-ready'),
			'btn__texteffect__4'  => esc_html__( 'Text Effect 4', 'element-ready'),
			'btn__texteffect__5'  => esc_html__( 'Text Effect 5', 'element-ready'),
			'btn__texteffect__6'  => esc_html__( 'Text Effect 6', 'element-ready'),
			'btn__texteffect__7'  => esc_html__( 'Text Effect 7', 'element-ready'),
			'btn__texteffect__8'  => esc_html__( 'Text Effect 8', 'element-ready'),
			'btn__texteffect__9'  => esc_html__( 'Text Effect 9', 'element-ready'),
			'btn__texteffect__10' => esc_html__( 'Text Effect 10', 'element-ready'),
			'btn__texteffect__11' => esc_html__( 'Text Effect 11', 'element-ready'),
			'btn__texteffect__12' => esc_html__( 'Text Effect 12', 'element-ready'),
			'btn__texteffect__13' => esc_html__( 'Text Effect 13', 'element-ready'),
			'btn__texteffect__14' => esc_html__( 'Text Effect 14', 'element-ready'),
			'btn__texteffect__15' => esc_html__( 'Text Effect 15', 'element-ready'),
			'btn__texteffect__16' => esc_html__( 'Text Effect 16', 'element-ready'),
			'btn__texteffect__17' => esc_html__( 'Text Effect 17', 'element-ready'),
			'btn__texteffect__18' => esc_html__( 'Text Effect 18', 'element-ready'),
			'btn__texteffect__19' => esc_html__( 'Text Effect 19', 'element-ready'),
			'btn__texteffect__20' => esc_html__( 'Text Effect 20', 'element-ready'),
			'btn__texteffect__21' => esc_html__( 'Text Effect 21', 'element-ready'),
			'btn__texteffect__22' => esc_html__( 'Text Effect 22', 'element-ready'),
			'btn__texteffect__23' => esc_html__( 'Text Effect 23', 'element-ready'),
			'btn__texteffect__24' => esc_html__( 'Text Effect 24', 'element-ready'),
			'btn__texteffect__25' => esc_html__( 'Text Effect 25', 'element-ready'),
			'btn__texteffect__26' => esc_html__( 'Text Effect 26', 'element-ready'),
			'btn__texteffect__27' => esc_html__( 'Text Effect 27', 'element-ready'),
			'btn__texteffect__28' => esc_html__( 'Text Effect 28', 'element-ready'),
			'btn__texteffect__29' => esc_html__( 'Text Effect 29', 'element-ready'),
			'btn__texteffect__30' => esc_html__( 'Text Effect 30', 'element-ready'),
			'btn__texteffect__31' => esc_html__( 'Text Effect 31', 'element-ready'),
			'btn__texteffect__32' => esc_html__( 'Text Effect 32', 'element-ready'),
			'btn__texteffect__33' => esc_html__( 'Text Effect 33', 'element-ready'),
		];
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'button_layout_style',
				[
					'label'   => esc_html__( 'Button Type', 'element-ready' ),
			...
			$this->add_control(
				'enable_hover_effect',
				[
					'label'        => esc_html__( 'Hover Effec ?', 'element-ready' ),
					'type'         => Controls_Manager::SWITCHER,
					'label_on'     => esc_html__( 'Enable', 'element-ready' ),
					'label_off'    => esc_html__( 'Disable', 'element-ready' ),
					'return_value' => 'yes',
					'default'      => 'no',
				]
			);
			...
			$this->add_control(
				'button_effect',
				[
					'label'     => esc_html__( 'Button Hover Effect', 'element-ready' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'ripple__btn',
			...
			$this->add_control(
				'enable_text_effect',
				[
					'label'        => esc_html__( 'Text Effec ?', 'element-ready' ),
					'type'         => Controls_Manager::SWITCHER,
					'label_on'     => esc_html__( 'Enable', 'element-ready' ),
					'label_off'    => esc_html__( 'Disable', 'element-ready' ),
					'return_value' => 'yes',
			...
			$this->add_control(
				'button_text_effect',
				[
					'label'     => esc_html__( 'Button Text Effect', 'element-ready' ),
					'type'      => Controls_Manager::SELECT,
			...
			$repeater->start_controls_tabs(
				...
				$repeater->start_controls_tab(
					...
					$repeater->add_control(
						...
						[
							'label'        => esc_html__( 'Woocommerce Download', 'element-ready' ),
							'type'         => Controls_Manager::SWITCHER,
					...
					$repeater->add_control(
						'free_product',
						[
							'label'        => esc_html__( 'Free Product Only ?', 'element-ready' ),
							'type'         => Controls_Manager::SWITCHER,
							'label_on'     => esc_html__( 'Show', 'element-ready' ),
							'label_off'    => esc_html__( 'Hide', 'element-ready' ),
							'return_value' => 'yes',
                    ...
                    if(function_exists('element_ready_wc_free_products')){
						...
						$repeater->add_control(
							'product_id',
							[
								'label'       => esc_html__( 'Product', 'element-ready' ),
					...
					$repeater->add_control(
						'button_link',
						[
							'label'         => esc_html__( 'Button Link', 'element-ready' ),
				...
				$repeater->start_controls_tab(
                    ...
                    $repeater->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Normal Style', 'element-ready' ),
                    ...
                    $repeater->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Hover Style', 'element-ready' ),
                            'type'      => Controls_Manager::HEADING,
                            'separator' => 'before',
                        ]
                    );
					...
					$repeater->add_control(
						...
						[
							'label'     => esc_html__( 'Button Hover Animated Background', 'element-ready' ),
							'type'      => Controls_Manager::HEADING,
							'separator' => 'before',
						]
					);
			...
			$this->add_control(
				'button_content',
				[
					'label'   => esc_html__( 'Add Button Item', 'element-ready' ),
					'type'    => Controls_Manager::REPEATER,
					'fields'  => $repeater->get_controls(),
					'default' => [
						[
							'title'             => esc_html__( 'Button Title', 'element-ready' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Wrap', 'element-ready' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		if($settings['woocommerce_download'] == 'yes'){
			...
			$attribute[] = 'href="'.$woocommerce_file_url.'"';
			$attribute[] = 'download';
