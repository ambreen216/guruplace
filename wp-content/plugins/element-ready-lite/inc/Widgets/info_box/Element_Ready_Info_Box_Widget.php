...
class Element_Ready_Info_Box_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Info Box', 'element-ready' );
    }
    ...
    public function element_ready_infobox_style(){
        return apply_filters( 'element_ready_infobox_style_presets', [
            'element__ready__infobox__style__1' => esc_html__( 'Style One', 'element-ready' ),
        ]);
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Infobox Content & Style', 'element-ready' ),
            ]
        );
            $this->add_control(
                'info_box_style',
                [
                    'label'   => esc_html__( 'Infobox Style', 'element-ready' ),
            ...
            $this->add_control(
                'title', [
                    'label'       => esc_html__( 'Header Title', 'element-ready' ),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__( 'My Title' , 'element-ready' ),
                    'label_block' => true,
                    'separator'   => 'before',
                ]
            );
            ...
            $repeater->start_controls_tab(
                ...
                $repeater->add_control(
                    'list_title', [
                        'label'       => esc_html__( 'Info Title', 'element-ready' ),
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'separator'   => 'before',
                    ]
                ...
                $repeater->add_control(
                    'list_content', [
                        'label'      => esc_html__( 'Info Content', 'element-ready' ),
            ...
            $repeater->start_controls_tab(
                ...
                $repeater->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Current Item Icon Style', 'element-ready' ),
                ...
                $repeater->add_control(
                    ...
                    [
                        'label'     => esc_html__( 'Current Item Style', 'element-ready' ),
                        'type'      => Controls_Manager::HEADING,
                        'separator' => 'before',
                    ]
                );
                ...
                $repeater->add_control(
                    'current_item_color',
                    [
                        'label'     => esc_html__( 'Description Color', 'element-ready' ),
                        'type'      => Controls_Manager::COLOR,
                        'separator' => 'before',
                        'selectors' => [
            ...
            $repeater->start_controls_tab(
                ...
                $repeater->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Current Item Hover Icon Style', 'element-ready' ),
                        'type'  => Controls_Manager::HEADING,
                    ]
                );
                $repeater->add_control(
                ...
                $repeater->add_control(
                    ...
                    [
                        'label'     => esc_html__( 'Current Item Hover Style', 'element-ready' ),
                        'type'      => Controls_Manager::HEADING,
                        'separator' => 'before',
                    ]
                );
            ...
            $this->add_control(
                'list_content',
                [
                    'label'   => esc_html__( 'Add Info Boxes', 'element-ready' ),
                    ...
                    'default' => [
                        [
                            ...
                            'list_title'   => esc_html__( 'PHONE:', 'element-ready' ),
                            'list_content' => esc_html__( '+88 01744 430 440', 'element-ready' ),
                        ],
                        [
                            'list_icon'   => [
                                'value' => 'far fa-envelope',
                            ],
                            'list_title'   => esc_html__( 'EMAIL:', 'element-ready' ),
                            'list_content' => esc_html__( 'mehedidb@gmail.com', 'element-ready' ),
                        ],
                        [
                            'list_icon'   => [
                                'value' => 'fas fa-map-marker-alt',
                            ],
                            'list_title'   => esc_html__( 'LOCATION:', 'element-ready' ),
                            'list_content' => esc_html__( '44 Canal Center Plaza #200 Alexandria, VA 22314, USA', 'element-ready' ),
                        ],
                    ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Infobox Wrapper', 'element-ready' ),
            ...
            $this->start_controls_tabs( 'icon_tabs_style' );
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        'icon_width',
                        [
                            'label'      => esc_html__( 'Icon Wrap Width', 'element-ready' ),
                    ...
                    $this->add_responsive_control(
                        'icon_height',
                        [
                            'label'      => esc_html__( 'Icon Wrap Height', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        'icon_size',
                        [
                            'label'      => esc_html__( 'Icon Size', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
        ...
        $this->start_controls_section(
            'box_style_section',
            [
                'label' => esc_html__( 'Single Info Box', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
