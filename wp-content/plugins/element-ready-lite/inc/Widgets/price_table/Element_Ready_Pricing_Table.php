...
class Element_Ready_Pricing_Table extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Price Table', 'element-ready' );
    }
    ...
    public function content_layout_style() {
        return apply_filters( 'element_ready_price_table_style_presets', [
            ...
            'pro-3'  => esc_html__( 'Style Three - PRO', 'element-ready' ),
            'pro-4'  => esc_html__( 'Style Four - PRO', 'element-ready' ),
            'pro-5'  => esc_html__( 'Style Five - PRO', 'element-ready' ),
            'pro-6'  => esc_html__( 'Style Six - PRO', 'element-ready' ),
            'pro-7'  => esc_html__( 'Style Seven - PRO', 'element-ready' ),
            'pro-8'  => esc_html__( 'Style Eight - PRO', 'element-ready' ),
            'pro-9'  => esc_html__( 'Style Nine - PRO', 'element-ready' ),
            'pro-10' => esc_html__( 'Style Ten - PRO', 'element-ready' ),
            'pro-11' => esc_html__( 'Style Eleven - PRO', 'element-ready' ),
            'pro-12' => esc_html__( 'Style Twelve - PRO', 'element-ready' ),
            'pro-13' => esc_html__( 'Style Thirteen - PRO', 'element-ready' ),
        ]);
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'        => esc_html__( 'Show Features Icon', 'element-ready' ),
            ...
            $this->add_control(
                ...
                [
                    'label'        => esc_html__( 'Active Price Plan', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'no',
                    'separator'   => 'before',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Ribbon', 'element-ready' ),
            ]
        );
            $this->add_control(
                'element_ready_ribon_pricing_table',
                [
                    'label'        => esc_html__( 'Ribon', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                ]
            );
            $this->add_control(
                'ribon_type',
                [
                    'label'   => esc_html__('Ribon Type','element-ready'),
                    'type'    => Controls_Manager::CHOOSE,
                    'options' => [
                        'text' =>[
                            'title' => esc_html__('Text','element-ready'),
                            'icon'  => 'fa fa-font',
                        ],
                        'img' =>[
                        ...
                        'font' =>[
                            'title' => esc_html__('Font Icon','element-ready'),
                            'icon'  => 'fa fa-info',
                        ],
                    ],
                    'default'   => 'text',
            ...
            $this->add_control(
                'ribon_font_icon',
                [
                    'label'     => esc_html__( 'Font Icons', 'element-ready' ),
            ...
            $this->add_control(
                'ribon_image_icon',
                [
                    'label'   => esc_html__( 'Image Icon / Image', 'element-ready' ),
            ...
            $this->add_control(
                'ribon_text_icon',
                [
                    'label'       => esc_html__( 'Ribon Text', 'element-ready' ),
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__('Ribon Position','element-ready'),
                    'type'    => Controls_Manager::CHOOSE,
                    'options' => [
                        'left' =>[
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Header', 'element-ready' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'        => Controls_Manager::TEXT,
                    'placeholder' => esc_html__( 'Standard', 'element-ready' ),
                    'default'     => esc_html__( 'Standard', 'element-ready' ),
                    'title'       => esc_html__( 'Enter your service title', 'element-ready' ),
                ]
            );
            $this->add_control(
                'subtitle',
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__('Image or Icon','element-ready'),
                    'type'    => Controls_Manager::CHOOSE,
                    'options' => [
                        'img' =>[
                            'title' => esc_html__('Image','element-ready'),
            ...
            $this->add_control(
                'headerimage',
                [
                    'label'   => esc_html__('Image','element-ready'),
                    'type'    => Controls_Manager::MEDIA,
                    'dynamic' => [
                        'active' => true,
                    ],
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
              ...
              [
                'label' => esc_html__( 'Price rate Order', 'element-ready' ),
            ...
            $this->add_responsive_control(
              ...
              [
                'label' => esc_html__( 'title Order', 'element-ready' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                  'px' => [
                    'min'  => -100,
            ...
            $this->add_responsive_control(
              ...
              [
                'label' => esc_html__( 'Body Order', 'element-ready' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                  'px' => [
                    'min'  => -100,
            ...
            $this->add_responsive_control(
              ...
              [
                'label' => esc_html__( 'Footer Order', 'element-ready' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                  'px' => [
                    'min'  => -100,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Pricing', 'element-ready' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__( 'Custom Product id (optional)', 'element-ready' ),
                    'type'    => Controls_Manager::TEXT,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'        => esc_html__( 'Offer', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Original Price', 'element-ready' ),
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__( 'Currency Symbol', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'options' => [
                        ''             => esc_html__( 'None', 'element-ready' ),
                        'dollar'       => '&#36; ' . esc_html__( 'Dollar', 'element-ready' ),
                        'euro'         => '&#128; ' . esc_html__( 'Euro', 'element-ready' ),
                        'baht'         => '&#3647; ' . esc_html__( 'Baht', 'element-ready' ),
                        'franc'        => '&#8355; ' . esc_html__( 'Franc', 'element-ready' ),
                        'guilder'      => '&fnof; ' . esc_html__( 'Guilder', 'element-ready' ),
                        'krona'        => 'kr ' . esc_html__( 'Krona', 'element-ready' ),
                        'lira'         => '&#8356; ' . esc_html__( 'Lira', 'element-ready' ),
                        'peseta'       => '&#8359 ' . esc_html__( 'Peseta', 'element-ready' ),
                        'peso'         => '&#8369; ' . esc_html__( 'Peso', 'element-ready' ),
                        'pound'        => '&#163; ' . esc_html__( 'Pound Sterling', 'element-ready' ),
                        'real'         => 'R$ ' . esc_html__( 'Real', 'element-ready' ),
                        'ruble'        => '&#8381; ' . esc_html__( 'Ruble', 'element-ready' ),
                        'rupee'        => '&#8360; ' . esc_html__( 'Rupee', 'element-ready' ),
                        'indian_rupee' => '&#8377; ' . esc_html__( 'Rupee (Indian)', 'element-ready' ),
                        'shekel'       => '&#8362; ' . esc_html__( 'Shekel', 'element-ready' ),
                        'yen'          => '&#165; ' . esc_html__( 'Yen/Yuan', 'element-ready' ),
                        'won'          => '&#8361; ' . esc_html__( 'Won', 'element-ready' ),
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__( 'Currency Position', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'options' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Custom Symbol', 'element-ready' ),
                    'type'      => Controls_Manager::TEXT,
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__( 'Period', 'element-ready' ),
                    'type'    => Controls_Manager::TEXT,
                    'default' => esc_html__( '/Monthly', 'element-ready' ),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'pricing_desc',
                [
                    'label' => esc_html__( 'Price Description', 'element-ready' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Features', 'element-ready' ),
            ]
        );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default'     => esc_html__( 'Features Tilte', 'element-ready' ),
                    'description' => sprintf( esc_html__( 'If you want to bold content just use %s in before and use %s after the word. and if you want to border use %s before the word use %s after the word. and if you want content right use %s before the word and use %s after the word.', 'element-ready' ),'<mark>[</mark>','<mark>]</mark>','<mark>{</mark>','<mark>}</mark>','<mark>(RIGHT)</mark>','<mark>(/RIGHTEND)</mark>' ),
                ]
            );
            ...
            $repeater->add_control(
                ...
                [
                    'label'        => esc_html__( 'Old Features', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                ]
            );
            ...
            $repeater->add_control(
                'features_icon_type',
                [
                    'label'   => esc_html__('Add Features Icon','element-ready'),
                    'type'    => Controls_Manager::CHOOSE,
                    'options' => [
                        'img' =>[
                            'title' => esc_html__('Image Icon','element-ready'),
                            'icon'  => 'fa fa-picture-o',
                        ],
                        'font' =>[
            ...
            $repeater->add_control(
                'features_image_icon',
                [
                    'label'   => esc_html__( 'Image Icon / SVG', 'element-ready' ),
                    'type'    => Controls_Manager::MEDIA,
                    'default' => [
                        'url' => Utils::get_placeholder_image_src(),
                    ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'element_ready_features_title'   => esc_html__( 'Features Title One', 'element-ready' ),
                            'element_ready_features_icon' => 'fa fa-angle-double-right',
                        ],

                        [
                            'element_ready_features_title'   => esc_html__( 'Features Title Two', 'element-ready' ),
                            'element_ready_features_icon' => 'fa fa-angle-double-right',
                        ],

                        [
                            'element_ready_features_title'   => esc_html__( 'Features Title Three', 'element-ready' ),
                            'element_ready_features_icon' => 'fa fa-angle-double-right',
                        ],
                    ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Footer', 'element-ready' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    'label'        => esc_html__( 'Show Price Button', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'default'      => 'yes',
                    'return_value' => 'yes',
                ]
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Button Text', 'element-ready' ),
                    'type'      => Controls_Manager::TEXT,
                    'default'   => esc_html__( 'Purchase Now', 'element-ready' ),
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Button Icon', 'element-ready' ),
                    'type'      => Controls_Manager::ICONS,
                    'label_block' => true,
                    'condition' => [
                        'element_ready_price_button' => 'yes',
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__( 'Icon Position', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'left',
                    'options' => [
                        'left'  => esc_html__( 'Before', 'element-ready' ),
                        'right' => esc_html__( 'After', 'element-ready' ),
                    ],
                    'condition' => [
                        'element_ready_button_icon!' => '',
                        'element_ready_price_button' => 'yes',
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Icon Spacing', 'element-ready' ),
                    'type'  => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'max' => 60,
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Header Area', 'element-ready' ),
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Header Area Hover Background', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Hover Title Color', 'element-ready' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Price Hover Color', 'element-ready' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Offer Price', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Hover Offer Color', 'element-ready' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Currency', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Hover Currency Color', 'element-ready' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Hover Preiord Color', 'element-ready' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
        ...
        $this->start_controls_section(
            'ribon_style_section',
            [
                'label' => esc_html__( 'Ribon Style', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'element_ready_ribon_pricing_table' => 'yes'
                ],
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        'ribon_image_width',
                        [
                            'label'      => esc_html__( 'Image Width', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        'ribon_image_height',
                        [
                            'label'      => esc_html__( 'Image Height', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'        => esc_html__( 'Image Filter', 'element-ready' ),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'From Left Offset', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', 'vw','%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'From Right Offset', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', 'vw','%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'From Top Offset', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', 'vw','%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'From Bottom Offset', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', 'vw','%' ],
                            'range'      => [
                                'px' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Features Area', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Features Area Hover Background', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Features Items', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Features Icon Style', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Footer Area', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Footer Area Hover Background', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->start_controls_tabs( 'before_after_tab_style' );
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label' => esc_html__( 'Transform', 'element-ready' ),
                    ...
                    $this->add_control(
                        'before_scale',
                        [
                            'label'      => esc_html__( 'Scale', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_control(
                        'before_rotate',
                        [
                            'label'      => esc_html__( 'Rotate', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_control(
                        'before_hover_hr',
                        [
                            'label'     => esc_html__( 'Before Hover', 'element-ready' ),
                            'type'      => Controls_Manager::HEADING,
                            'separator' => 'after',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'after_hover_hr',
                        [
                            'label'     => esc_html__( 'After Hover', 'element-ready' ),
                            'type'      => Controls_Manager::HEADING,
                            'separator' => 'after',
                        ]
                    );
            ...
            <?php
                if( $settings['element_ready_offer_price'] == 'yes' && !empty( $settings['element_ready_original_price'] ) ){
                    ...
                    if ( 'left' == $settings['element_ready_currency_position'] ) {
                        echo '<h3><span class="old__price">'.$currencysymbol.'<del>'.esc_attr__( $settings['element_ready_original_price'],'element-ready' ).'</del></span><span class="new__price">'.$currencysymbol.esc_attr__( $settings['element_ready_price'],'element-ready' ).'</span> <span class="period__price">'.esc_attr__( $settings['element_ready_period'],'element-ready' ).'</span></h3>';
                    }elseif ( 'right' == $settings['element_ready_currency_position'] ) {
                        echo '<h3><span class="old__price">'.'<del>'.esc_attr__( $settings['element_ready_original_price'],'element-ready' ).$currencysymbol.'</del></span><span class="new__price">'.esc_attr__( $settings['element_ready_price'],'element-ready' ).$currencysymbol.'</span> <span class="period__price">'.esc_attr__( $settings['element_ready_period'],'element-ready' ).'</span></h3>';
                    }
                }else{
                    if( !empty($settings['element_ready_price']) ){
                        if ( 'left' == $settings['element_ready_currency_position'] ) {
                            echo '<h3><span class="new__price">'.$currencysymbol.esc_attr__( $settings['element_ready_price'],'element-ready' ).'</span> <span class="period__price">'.esc_attr__( $settings['element_ready_period'],'element-ready' ).'</span></h3>';
                        }elseif ( 'right' == $settings['element_ready_currency_position'] ) {
                            echo '<h3><span class="new__price">'.esc_attr__( $settings['element_ready_price'],'element-ready' ).$currencysymbol.'</span> <span class="period__price">'.esc_attr__( $settings['element_ready_period'],'element-ready' ).'</span></h3>';
                        }
                    }
                }
            ?>
                            ...
                            <?php
                                if( 'yes' == $settings['element_ready_show_features_icon'] ){
                                    ...
                                    if( !empty( $features['features_image_icon'] ) &&  'img' == $features['features_icon_type'] ){  
                                        ...
                                        echo element_ready_render_icons( $features['element_ready_features_icon'] );
                                    }
                                }
        ...
        if ( 'yes' == $settings['element_ready_price_button'] ) {
                ...
                if ( !empty( $icons_data ) ) {
                    ...
                    if ( 'left'  == $settings['element_ready_button_icon_alignment'] ) {
                        echo '<div class="single__price__footer">'.sprintf( '<a %1$s>%2$s %3$s</a>', $this->get_render_attribute_string( 'url' ), element_ready_render_icons( $settings['element_ready_button_icon'], 'price_btn_icon_left' ), $settings['element_ready_button_text'] ).'</div>';
                    }elseif ( 'right'  == $settings['element_ready_button_icon_alignment'] ) {
                        echo '<div class="single__price__footer">'.sprintf( '<a %1$s>%2$s %3$s</a>', $this->get_render_attribute_string( 'url' ), $settings['element_ready_button_text'], element_ready_render_icons( $settings['element_ready_button_icon'], 'price_btn_icon_right' ) ).'</div>';
                    }
                }else{
