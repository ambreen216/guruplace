...
class Signin extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Login', 'element-ready' );
    }
    ...
    public function layout(){
        return[
            ...
            'style1'   => esc_html__( 'style1', 'element-ready' ),
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'signup_',
                [
                    'label'        => esc_html__( 'SsignUp Button', 'element-ready' ),
            ...
            $this->add_control(
                'signup_url', [
                    'label'			  => esc_html__( 'SignUp Path', 'element-ready' ),
            ...
            $this->add_control(
                'signup_text', [
                    'label'			  => esc_html__( 'SignUp Text', 'element-ready' ),
                    'type'			  => Controls_Manager::TEXT,
                    'label_block'	  => true,
                    'default'	     => 'SignUp',
                    'condition' => [
            ...
            $this->add_control(
                'custom_redirect',
                [
                    'label'        => esc_html__( 'Custom Redirect', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Yes', 'element-ready' ),
                    'label_off'    => esc_html__( 'No', 'element-ready' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                'login_redirect_url', [
                    'label'			  => esc_html__( 'Success Redirect Path', 'element-ready' ),
                    'type'			  => Controls_Manager::TEXT,
                    'label_block'	  => true,
                    'default'	     => '#',
                    'condition' => [
        ...
        $this->registration_button_css(esc_html__('SignUp Button','element-ready'),'sign_up_button_cont','signup__btn_element');
        $this->login_button_css(esc_html__('Login Button','element-ready'),'sign__button_cont','signin__btn_element');
   
        $this->lost_pass_button_css(esc_html__('Lost Password','element-ready'),'slost_pass_cont','slost_password_element');
      
        $this->start_controls_section(
            'section_fields',
            [
                'label' => esc_html__('Login Fields', 'element-ready'),
            ]
        );
        ...
        $this->add_control(
            'custom_fld_icon',
            [
                'label'        => esc_html__( 'Field Icon', 'element-ready' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'element-ready' ),
                'label_off'    => esc_html__( 'No', 'element-ready' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'custom_lebel',
            [
                'label'        => esc_html__( 'Lebel ?', 'element-ready' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'element-ready' ),
                'label_off'    => esc_html__( 'No', 'element-ready' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'login_username_placeholder', [
                'label'			  => esc_html__( 'Username placeholder', 'element-ready' ),
                'type'			  => Controls_Manager::TEXT,
                'label_block'	  => true,
                'placeholder'    => esc_html__( 'username ', 'element-ready' ),
                'default'	     => esc_html__( 'Username ', 'element-ready' ),
        ...
        $this->add_control(
            'login_username_label', [
                'label'			  => esc_html__( 'Username Label', 'element-ready' ),
                'type'			  => Controls_Manager::TEXT,
                'label_block'	  => true,
                'placeholder'    => esc_html__( 'username ', 'element-ready' ),
                'default'	     => esc_html__( 'Username ', 'element-ready' ),
        ...
        $this->add_control(
			'login_username_icon',
			[
				'label' => __( 'User Icon', 'element-ready' ),
        ...
        $this->add_control(
            'login_password_placeholder', [
                'label'			  => esc_html__( 'Password placeholder', 'element-ready' ),
                'type'			  => Controls_Manager::TEXT,
                'label_block'	  => true,
                'placeholder'    => esc_html__( 'password ', 'element-ready' ),
                'default'	     => esc_html__( 'password ', 'element-ready' ),
        ...
        $this->add_control(
            'login_password_label', [
                'label'			  => esc_html__( 'Password Label', 'element-ready' ),
                'type'			  => Controls_Manager::TEXT,
                'label_block'	  => true,
                'placeholder'    => esc_html__( 'password ', 'element-ready' ),
                'default'	     => esc_html__( 'password ', 'element-ready' ),
        ...
        $this->add_control(
			'login_password_icon',
			[
				'label' => __( 'Password Icon', 'element-ready' ),
				'type' => \Elementor\Controls_Manager::ICONS,
				'default' => [
					'value' => 'fas fa-user',
					'library' => 'solid',
        ...
        $this->add_control(
            'login_submit_text', [
                'label'			  => esc_html__( 'Submit text', 'element-ready' ),
                'type'			  => Controls_Manager::TEXT,
                'label_block'	  => true,
                'placeholder'    => esc_html__( 'Submit ', 'element-ready' ),
                'default'	     => esc_html__( 'Login', 'element-ready' ),
        ...
        $this->add_control(
            'signup_submit_icon',
            [
                'label' => __( 'Submit Icon', 'element-ready' ),
                'type' => \Elementor\Controls_Manager::ICONS,
                'default' => [
                    'value' => 'fas fa-user',
                    'library' => 'solid',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Login Remember ', 'element-ready'),
            ]
        );
                ...
                $this->add_control(
                    'remember_show',
                    [
                        'label'        => esc_html__( 'show', 'element-ready' ),
                        'type'         => Controls_Manager::SWITCHER,
                        'label_on'     => esc_html__( 'Yes', 'element-ready' ),
                        'label_off'    => esc_html__( 'No', 'element-ready' ),
                        'return_value' => 'yes',
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'default'     => esc_html__( 'Remember Me', 'element-ready' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Login Lost Password ', 'element-ready'),
            ]
        );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'default'     => esc_html__( 'Lost Password', 'element-ready' ),
                        'placeholder' => esc_html__( 'Type your title here', 'element-ready' ),
                    ]
                );
         ...
         $this->box_css(
            array(
                'title' => esc_html__('Remember Wrapper','element-ready'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Remember', 'element-ready' ),
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Spacial Text Color', 'element-ready' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Checkbox Color', 'element-ready' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Check box bgColor', 'element-ready' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->start_controls_tabs( 'input_box_tabs' );
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Background Color', 'element-ready' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Label & Icon', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Label Color', 'element-ready' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__( 'Label font', 'element-ready' ),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('User Name Field','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('User Name Lebel','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('User Name Icon','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Password Field','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Password Lebel','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Password Icon','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Submit Icon','element-ready'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Success Message', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Message Color', 'element-ready' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__( 'Message', 'element-ready' ),
        ...
        $this->start_controls_section(
            'error__msg_section',
            [
                'label' => esc_html__( 'Error Message', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_responsive_control(
