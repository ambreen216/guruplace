...
class Element_Ready_Testmonial_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'ER Testmonial', 'element-ready' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'testmonial_style',
				[
					'label'   => esc_html__( 'Testmonial Type', 'element-ready' ),
			...
			$this->add_control(
				'show_icon',
				[
					'label'        => esc_html__( 'Show Quotation Icon ?', 'element-ready' ),
			...
			$this->add_control(
				...
				[
					...
					'default' => 'font_icon',
					'options' => [
						'font_icon'  => esc_html__( 'SVG / Font Icon', 'element-ready' ),
						'image_icon' => esc_html__( 'Image Icon', 'element-ready' ),
					],
					'condition' => [
						'show_icon' => 'yes',
					],
			...
			$this->add_control(
				'font_icon',
				[
					'label'     => esc_html__( 'SVG / Font Icons', 'element-ready' ),
			...
			$repeater->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'Title', 'element-ready' ),
				]
			);
			...
			$repeater->add_control(
				'subtitle',
				[
					'label'       => esc_html__( 'Subtitle', 'element-ready' ),
					'type'        => Controls_Manager::TEXT,
					'placeholder' => esc_html__( 'Subtitle', 'element-ready' ),
				]
			);
			...
			$repeater->add_control(
				'subtitle_position',
				[
					'label'   => esc_html__( 'Subtitle Position', 'element-ready' ),
					'type'    => Controls_Manager::SELECT,
					'default' => 'after_title',
					'options' => [
						'before_title' => esc_html__( 'Before title', 'element-ready' ),
						'after_title'  => esc_html__( 'After Title', 'element-ready' ),
					],
					'condition' => [
						'subtitle!' => '',
					]
			...
			$repeater->add_control(
				'member_thumb',
				[
					'label'       => esc_html__( 'Testmonial Author Thumb', 'element-ready' ),
					'type'        => Controls_Manager::MEDIA,
					'default' => [
						'url' => Utils::get_placeholder_image_src(),
					],
			...
			$repeater->add_control(
				'member_name',
				[
					'label'       => esc_html__( 'Testmonial Author Name', 'element-ready' ),
					'type'        => Controls_Manager::TEXT,
			...
			$this->add_control(
				'testmonial_content',
				[
					'label' => esc_html__( 'Testmonial Items', 'element-ready' ),
					'type' => Controls_Manager::REPEATER,
					'fields' => $repeater->get_controls(),
					'default' => [
						[
							'member_name' => esc_html__( 'M Hasan', 'element-ready' ),
							'designation' => esc_html__( 'Web Developer' ),
							'description' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga quos pariatur tempore nihil quisquam tempora odio et mollitia. Ea facere expedita beatae nesciunt vero aliquam similique eius veritatis unde eligendi.', 'element-ready' ),
						],
						[
							'member_name' => esc_html__( 'M Hasan', 'element-ready' ),
							'designation' => esc_html__( 'Web Developer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Nav Warp', 'element-ready' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Nav Button', 'element-ready' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Thumbs Slider', 'element-ready' ),
			...
			$this->start_controls_tabs( 'icon_tab_style' );
				$this->start_controls_tab(
					...
					$this->add_responsive_control(
						'icon_image_size',
						[
							'label'      => esc_html__( 'SVG / Image Icon Size', 'element-ready' ),
							'type'       => Controls_Manager::SLIDER,
							'size_units' => [ 'px', '%' ],
							'range'      => [
								'px' => [
			...
			$this->start_controls_tabs( 'title_tab_style' );
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						'hover_title_color',
						[
							'label'     => esc_html__( 'Link Color', 'element-ready' ),
							'type'      => Controls_Manager::COLOR,
							'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Thumb & Designation Warp', 'element-ready' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
			$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Testimonial Wrap', 'element-ready' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Testimonial Before / After', 'element-ready' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'testmonial_style' => 'tesmonial_style_3',
				],
