...
class Element_Ready_Scroll_Button extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'ER Scroll Top Bottom', 'element-ready' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'scroll_type',
				[
					'label'   => esc_html__( 'Scrolling Type', 'element-ready' ),
					'type'    => Controls_Manager::SELECT,
					'default' => 'scroll_top',
					'options' => [
						'scroll_top'  => esc_html__( 'Scroll To Top', 'element-ready' ),
						'scroll_bottom' => esc_html__( 'Scroll Bottom Section', 'element-ready' ),
					],
				]
			);
			$this->add_control(
				'button_anchor_id',
				[
					'label'         => esc_html__( 'Scroll Area / Section Id', 'element-ready' ),
					'type'          => Controls_Manager::TEXT,
					'placeholder'   => esc_html__( 'Scroll Section Id', 'element-ready' ),
					'default'       => 'service',
					'condition' => [
			...
			$this->add_control(
				'scroll_icon',
				[
					'label'       => esc_html__( 'Chose Icon', 'element-ready' ),
			...
			$this->start_controls_tabs( 'icon_tab_style' );
				$this->start_controls_tab(
					...
					$this->add_responsive_control(
						'icon_image_size',
						[
							'label'      => esc_html__( 'Icon Image Size', 'element-ready' ),
							'type'       => Controls_Manager::SLIDER,
							'size_units' => [ 'px', '%' ],
							'range'      => [
								'px' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 'button_style_attr', 'class', $settings['scroll_type'] );
		...
		if ( !empty( $settings['button_anchor_id'] ) ) {
			$this->add_render_attribute( 'button_style_attr', 'href', '#'.$settings['button_anchor_id'] );
		}else{
