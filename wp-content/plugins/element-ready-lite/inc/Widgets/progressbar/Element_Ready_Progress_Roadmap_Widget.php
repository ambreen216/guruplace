...
class Element_Ready_Progress_Roadmap_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'ER Progress Roadmap', 'element-ready' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'progressbar_percent',
			[
				'label'      => esc_html__( 'Progress Percent', 'element-ready' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Progress Wrap', 'element-ready' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Progressbar', 'element-ready' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Progress Count Bar', 'element-ready' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'roadmap_style_attr', 'id', 'element__ready__roadmap__timeline__'.$random_id );
