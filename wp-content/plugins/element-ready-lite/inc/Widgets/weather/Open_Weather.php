...
class Open_Weather extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Weather', 'element-ready' );
    }
   ...
   public function get_style_depends(){
    ...
    protected function _register_controls() {
       ...
       $this->end_controls_section();
        ...
        $this->content_text([
            'title' => esc_html__('Settings','element-ready'),
         ...
         $this->content_text([
            'title' => esc_html__('Content Settings','element-ready'),
            'slug' => '_content',
            'condition' => '',
            'controls' => [
                ...
                'show_time'=> [
                    'label'        => esc_html__( 'Time Enable', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'element-ready' ),
                    'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
                ...
                'time_title'=> [
                    'label'   => esc_html__( 'Time', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::TEXT,
                    'default' => esc_html__('Today','element-ready'),
                    'condition' =>[
                        'show_time' => ['yes']
                    ]
                ],
                ...
                'humidity_show'=> [
                    'label'        => esc_html__( 'Humidity', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'element-ready' ),
                    'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
                ...
                'humidity_title'=> [
                    'label'   => esc_html__( 'Humidity', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::TEXT,
                    'default' => esc_html__('Humidity','element-ready'),
                    'condition' =>[
                        'humidity_show' => ['yes']
                    ]
                ],
                ...
                'wind_speed_show'=> [
                    'label'        => esc_html__( 'Wind Speed', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'element-ready' ),
                    'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
                ...
                'wind_speed_title'=> [
                    'label'   => esc_html__( 'Wind Speed', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::TEXT,
                    'default' => esc_html__('Speed','element-ready'),
                    'condition' =>[
                        'wind_speed_show' => ['yes']
                    ]
                ],
                ...
                'wind_deg_show'=> [
                    'label'        => esc_html__( 'Wind deg', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'element-ready' ),
                    'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
                ...
                'wind_deg_title'=> [
                    'label'   => esc_html__( 'Wind Deg', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::TEXT,
                    'default' => esc_html__('Deg','element-ready'),
                    'condition' =>[
                        'wind_deg_show' => ['yes']
                    ]
                ],
                ...
                'show_weather_icon'=> [
                    'label'        => esc_html__( 'Icon Enable', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'element-ready' ),
                    'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
                ...
                'show_weather_desc'=> [
                    'label'        => esc_html__( 'Desc Enable', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'element-ready' ),
                    'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
                ...
                'show_weather_slide'=> [
                    'label'        => esc_html__( 'Slide Enable', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'element-ready' ),
                    'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
         ...
         $this->content_text([
            'title' => esc_html__('Content Order','element-ready'),
            'slug' => 'order_content_item',
            'condition' => '',
            'controls' => [
           
                'time_order'=> [
                    'label'   => esc_html__( 'Time Order', 'element-ready' ),
                ...
                'icon_order'=> [
                    'label'   => esc_html__( 'Icon Order', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::NUMBER,
                    'min' => -100,
				    'max' => 100,
				    'step' => 5,
                ...
                'desc_order'=> [
                    'label'   => esc_html__( 'Desc Order', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::NUMBER,
                    'min' => -100,
				    'max' => 100,
				    'step' => 5,
                ...
                'temp_order'=> [
                    'label'   => esc_html__( 'Tempareture Order', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::NUMBER,
                    'min' => -100,
				    'max' => 100,
				    'step' => 5,
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Header','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Time Wrapper','element-ready'),
        ...
        $this->text_css(
            array(
                'title' => esc_html__('Time','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Weather Desc','element-ready'),
                ...
                <div class="temp">
                    ...
                    <span>
                        ...
                        <?php if($settings['units'] == 'metric'): ?>
                            <?php echo esc_html__('°C', 'element-ready'); ?>
                        <?php elseif($settings['units'] == 'imperial'): ?>
                            <?php echo esc_html__('°F', 'element-ready'); ?>
                        <?php else: ?>
                            <?php echo esc_html__('K', 'element-ready'); ?>
                        <?php endif; ?>
