...
class Element_Ready_Portfolio extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Portfolio', 'element-ready' );
    }
    ...
    static function content_layout_style(){
        return apply_filters( 'element_ready_portfolio_style_presets', [
            '1'      => esc_html__( 'Layout One', 'element-ready' ),
            '2'      => esc_html__( 'Layout Two', 'element-ready' ),
            '3_pro'      => esc_html__( 'Layout Three - PRO', 'element-ready' ),
            '4_pro'      => esc_html__( 'Layout Four - PRO', 'element-ready' ),
            '5_pro'      => esc_html__( 'Layout Five - PRO', 'element-ready' ),
            '6_pro'      => esc_html__( 'Layout Six - PRO', 'element-ready' ),
            '7_pro'      => esc_html__( 'Layout Seven - PRO', 'element-ready' ),
            '8_pro'      => esc_html__( 'Layout Eight - PRO', 'element-ready' ),
            'custom_pro' => esc_html__( 'Layout Custom - PRO', 'element-ready' ),
        ]);
    }
    ...
    static function element_ready_post_layout(){
        return apply_filters( 'element_ready_portfolio_layout_style_presets', [
            ...
            'filtering_PRO'      => esc_html__( 'Filtering - PRO', 'element-ready' ),
            'masonry_PRO'        => esc_html__( 'Masonry - PRO', 'element-ready' ),
            'masonry_filter_PRO' => esc_html__( 'Masonry Filter - PRO', 'element-ready' ),
            'genaral_filter_PRO' => esc_html__( 'Genaral Filter - PRO', 'element-ready' ),
        ] );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Content layout Style', 'element-ready' ),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Layout Settings', 'element-ready' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Gallery Layout Style', 'element-ready' ),
            ...
            $this->add_control(
                'gallery_type',
                [
                    'label'     => esc_html__( 'Gallery Style', 'element-ready' ),
                    'type'      => Controls_Manager::SELECT,
                    'default'   => 'genaral',
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Slider Settings', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'gallery_type' => 'slider',
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Gallery Settings', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'gallery_type!' => 'slider',
            ...
            $this->add_control(
                'layout_mode',
                [
                    'label'   => esc_html__( 'Fitering Layout Mode', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'fitRows',
                    'options' => [
                        'masonry'           => esc_html__( 'Masonry', 'element-ready' ),
                        'masonryHorizontal' => esc_html__( 'Masonry Horizontal', 'element-ready' ),
                        'fitRows'           => esc_html__( 'Fit Rows', 'element-ready' ),
                        'fitColumns'        => esc_html__( 'Fit Columns', 'element-ready' ),
                        'cellsByColumn'     => esc_html__( 'Cells By Column', 'element-ready' ),
                    ],
                    'separator' => 'before',
                    'condition' => [
                        'gallery_type!' => 'slider',
            ...
            $this->add_control(
                'show_all_menu',
                [
                    'label'        => esc_html__( 'Show All Category', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'On', 'element-ready' ),
                    'label_off'    => esc_html__( 'Off', 'element-ready' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                ...
                [
                    'label'        => esc_html__( 'Active Custom Category ?', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'On', 'element-ready' ),
                    'label_off'    => esc_html__( 'Off', 'element-ready' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                ...
                [
                    'label'       => esc_html__( 'Active Category', 'element-ready' ),
                    'type'        => Controls_Manager::SELECT,
                    'options'     => self::element_ready_get_taxonomies('portfolio_category'),
                    'description' => esc_html__( 'If you want to by default active a defferent cartegory, Please provide a category name which you provide in categoy as gallery item.','element-ready' ),
                    'condition'   => [
                        'gallery_type!'          => 'slider',
                        'gallery_menu'           => 'yes',
            ...
            $this->add_responsive_control(
                'gallery_gutter',
                [
                    'label'      => esc_html__( 'Columns Gutter', 'element-ready' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => [ 'px','%' ],
                    'range'      => [
                        'px' => [
        ...
        $this->start_controls_section(
            'post_content_option',
            [
                'label' => esc_html__( 'Post Option', 'element-ready' ),
            ]
        );
            ...
            $this->add_control(
                'carousel_post_type',
                [
                    'label'       => esc_html__( 'Content Sourse', 'element-ready' ),
            ...
            $this->add_control(
                'post_limit',
                [
                    'label'     => esc_html__('Limit', 'element-ready'),
            ...
            $this->add_control(
                'custom_order',
                [
                    'label'        => esc_html__( 'Custom order', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'no',
                ]
            ...
            $this->add_control(
                'orderby',
                [
                    'label'   => esc_html__( 'Orderby', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'none',
                    'options' => [
                        'none'          => esc_html__('None','element-ready'),
                        'ID'            => esc_html__('ID','element-ready'),
                        'date'          => esc_html__('Date','element-ready'),
                        'name'          => esc_html__('Name','element-ready'),
                        'title'         => esc_html__('Title','element-ready'),
                        'comment_count' => esc_html__('Comment count','element-ready'),
                        'rand'          => esc_html__('Random','element-ready'),
                    ],
                    'condition' => [
                        'custom_order' => 'yes',
                    ]
            ...
            $this->add_control(
                'show_thumb',
                [
                    'label'        => esc_html__( 'Thumbnail', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
            ...
            $this->add_control(
                'show_date',
                [
                    'label'        => esc_html__( 'Date', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
            ...
            $this->add_control(
                'date_type',
                [
                    'label'   => esc_html__( 'Date Type', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'date',
                    'options' => [
                        'date'     => esc_html__('Date','element-ready'),
                        'time'     => esc_html__('Time','element-ready'),
                        'time_ago' => esc_html__('Time Ago','element-ready'),
            ...
            $this->add_control(
                'title_length',
                [
                    'label'     => esc_html__( 'Title Length', 'element-ready' ),
                    'type'      => Controls_Manager::NUMBER,
                    'step'      => 1,
                    'default'   => 5,
                    'condition' => [
            ...
            $this->add_control(
                'content_length',
                [
                    'label'     => esc_html__( 'Content Length', 'element-ready' ),
                    'type'      => Controls_Manager::NUMBER,
                    'step'      => 1,
                    'default'   => 20,
                    'condition' => [
            ...
            $this->add_control(
                'show_read_more_btn',
                [
                    'label'        => esc_html__( 'Read More', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
            ...
            $this->add_control(
                'read_more_txt',
                [
                    'label'       => esc_html__( 'Read More button text', 'element-ready' ),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__( 'Read More', 'element-ready' ),
                    'placeholder' => esc_html__( 'Read More', 'element-ready' ),
                    'label_block' => true,
                    'condition'   => [
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__( 'Icon Postion', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'right',
                    'options' => [
        ...
        $this->start_controls_section(
            'slider_option',
            [
                'label'     => esc_html__( 'Carousel Option', 'element-ready' ),
                'condition' => [
                    'slider_on' => 'yes',
                ]
            ]
            ...
            $this->add_control(
                'slitems',
                [
                    'label'     => esc_html__( 'Slider Items', 'element-ready' ),
                    'type'      => Controls_Manager::NUMBER,
                    'min'       => 1,
                    'max'       => 20,
                    'step'      => 1,
            ...
            $this->add_control(
                'slrows',
                [
                    'label'     => esc_html__( 'Slider Rows', 'element-ready' ),
                    'type'      => Controls_Manager::NUMBER,
                    'min'       => 1,
                    'max'       => 5,
                    'step'      => 1,
            ...
            $this->add_responsive_control(
                'slitemmargin',
                [
                    'label'     => esc_html__( 'Slider Item Margin', 'element-ready' ),
                    'type'      => Controls_Manager::NUMBER,
                    'min'       => 0,
                    'max'       => 100,
                    'step'      => 1,
            ...
            $this->add_control(
                'slarrows',
                [
                    'label'        => esc_html__( 'Slider Arrow', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'yes',
            ...
            $this->add_control(
                'nav_position',
                [
                    'label'   => esc_html__( 'Arrow Position', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
            ...
            $this->add_control(
                'slprevicon',
                [
                    'label'     => esc_html__( 'Previous icon', 'element-ready' ),
                    'type'      => Controls_Manager::ICON,
                    'label_block' => true,
            ...
            $this->add_control(
                'slnexticon',
                [
                    'label'     => esc_html__( 'Next icon', 'element-ready' ),
                    'type'      => Controls_Manager::ICON,
                    'label_block' => true,
            ...
            $this->add_control(
                'nav_visible',
                [
                    'label'   => esc_html__( 'Arrow Visibility', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
            ...
            $this->add_control(
                'sldots',
                [
                    'label'        => esc_html__( 'Slider dots', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'no',
            ...
            $this->add_control(
                'slcentermode',
                [
                    'label'        => esc_html__( 'Center Mode', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'no',
            ...
            $this->add_control(
                'slcenterpadding',
                [
                    'label'     => esc_html__( 'Center padding', 'element-ready' ),
                    'type'      => Controls_Manager::NUMBER,
                    'min'       => 0,
                    'max'       => 500,
                    'step'      => 1,
            ...
            $this->add_control(
                'slfade',
                [
                    'label'        => esc_html__( 'Slider Fade', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'no',
            ...
            $this->add_control(
                'slfocusonselect',
                [
                    'label'        => esc_html__( 'Focus On Select', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'no',
            ...
            $this->add_control(
                'slvertical',
                [
                    'label'        => esc_html__( 'Vertical Slide', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'no',
            ...
            $this->add_control(
                'slinfinite',
                [
                    'label'        => esc_html__( 'Infinite', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'yes',
            ...
            $this->add_control(
                'slrtl',
                [
                    'label'        => esc_html__( 'RTL Slide', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'no',
            ...
            $this->add_control(
                'slautolay',
                [
                    'label'        => esc_html__( 'Slider auto play', 'element-ready' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'separator'    => 'before',
                    'default'      => 'no',
            ...
            $this->add_control(
                'slautoplay_speed',
                [
                    'label'     => esc_html__('Autoplay speed', 'element-ready'),
                    'type'      => Controls_Manager::NUMBER,
                    'default'   => 3000,
                    'condition' => [
                        'slider_on' => 'yes',
            ...
            $this->add_control(
                'slanimation_speed',
                [
                    'label'     => esc_html__('Autoplay animation speed', 'element-ready'),
                    'type'      => Controls_Manager::NUMBER,
                    'default'   => 300,
                    'condition' => [
                        'slider_on' => 'yes',
            ...
            $this->add_control(
                'slscroll_columns',
                [
                    'label'     => esc_html__('Slider item to scroll', 'element-ready'),
                    'type'      => Controls_Manager::NUMBER,
                    'min'       => 1,
                    'max'       => 10,
                    'step'      => 1,
            ...
            $this->add_control(
                'heading_tablet',
                [
                    'label'     => esc_html__( 'Tablet', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'after',
                    'condition' => [
                        'slider_on' => 'yes',
            ...
            $this->add_control(
                'sltablet_width',
                [
                    'label'       => esc_html__('Tablet Resolution', 'element-ready'),
                    'description' => esc_html__('The resolution to tablet.', 'element-ready'),
                    'type'        => Controls_Manager::NUMBER,
                    'default'     => 750,
                    'condition'   => [
                        'slider_on' => 'yes',
            ...
            $this->add_control(
                'heading_mobile',
                [
                    'label'     => esc_html__( 'Mobile Phone', 'element-ready' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'after',
                    'condition' => [
                        'slider_on' => 'yes',
            ...
            $this->add_control(
                'slmobile_width',
                [
                    'label'       => esc_html__('Mobile Resolution', 'element-ready'),
                    'description' => esc_html__('The resolution to mobile.', 'element-ready'),
                    'type'        => Controls_Manager::NUMBER,
                    'default'     => 480,
                    'condition'   => [
                        'slider_on' => 'yes',
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__( 'Item Columns Manager', 'element-ready' ),
            ...
            $repeater->add_responsive_control(
                ...
                [
                    'label'   => esc_html__( 'Display Columns', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'options' => [
                        'col-md-3 col-lg-3 col-sm-6 col-xs-12'    => esc_html__( '3 Columns', 'element-ready' ),
                        'col-md-4 col-lg-4 col-sm-6 col-xs-12'    => esc_html__( '4 Columns', 'element-ready' ),
                        'col-md-6 col-lg-6 col-sm-6 col-xs-12'    => esc_html__( '6 Columns', 'element-ready' ),
                        'col-md-12 col-lg-12 col-sm-12 col-xs-12' => esc_html__( '12 Columns', 'element-ready' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'style_repeter',
                [
                    'label' => esc_html__( 'Style List', 'element-ready' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__( 'Area Style', 'element-ready' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Menu Wrap', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'gallery_type!' => 'slider',
                ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'   => esc_html__( 'Float', 'element-ready' ),
                    'type'    => Controls_Manager::SELECT,
                    'options' => [
                        'left'     => esc_html__( 'Left', 'element-ready' ),
                        'right'    => esc_html__( 'Right', 'element-ready' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Menu Item', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'gallery_type!' => 'slider',
                ],
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'              => esc_html__( 'Item Margin Vartically', 'element-ready' ),
                    'type'               => Controls_Manager::DIMENSIONS,
                    'size_units'         => [ 'px', '%', 'em' ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__( 'Nth Child 2 Margin Vartically', 'element-ready' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range' => [
                        'px' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__( 'Item Hover Margin Vartically', 'element-ready' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range' => [
                        'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__( 'Hover Content Box', 'element-ready' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_content' => 'yes',
                ]
            ...
            $this->add_control(
                ...
                [
                    'label'  => esc_html__( 'Title Color', 'element-ready' ),
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'  => esc_html__( 'Readmore Color', 'element-ready' ),
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'  => esc_html__( 'Readmore Hover Color', 'element-ready' ),
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Slider Arrow Warp', 'element-ready' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'slider_on' => 'yes',
                    'slarrows'  => 'yes',
        ...
        $this->start_controls_section(
            'slider_arrow_style',
            [
                'label'     => esc_html__( 'Arrow', 'element-ready' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'slider_on' => 'yes',
                    'slarrows'  => 'yes',
            ...
            $this->start_controls_tabs( 'slider_arrow_style_tabs' );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'Font Size', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'Left Arrow Position From Left', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'Left Arrow Position From Top', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'Right Arrow Position From Right', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'Right Arrow Position From Top', 'element-ready' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__( 'Pagination', 'element-ready' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'slider_on' => 'yes',
                    'sldots'  => 'yes',
            ...
            $this->start_controls_tabs('pagination_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'      => esc_html__( 'Pagination Warp Margin', 'element-ready' ),
                            'type'       => Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                    ...
                    $this->add_responsive_control(
                        'pagi_war_align',
                        [
                            'label'   => esc_html__( 'Pagination Warp Alignment', 'element-ready' ),
                            'type'    => Controls_Manager::CHOOSE,
                            'options' => [
                                'left' => [
                                    'title' => esc_html__( 'Left', 'element-ready' ),
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'content_single_item_attr', 'class', 'element__ready__single__portfolio element__ready__portfolio__layout__'.$settings['content_layout_style'] );
            ...
            <div class="filter__menu" id="filter__menu__<?php echo esc_attr( $gallery_id ); ?>">
                <ul>
                    <?php if ( 'yes' == $settings['show_all_menu'] ) : ?>
                        <li class="filter active" data-filter="*"><?php esc_html_e( 'All', 'element-ready' ); ?></li>
                    <?php endif; ?>
                    <?php
    ...
    public function element_ready_time_ago() {
        return human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ).' '.__( 'ago','element-ready' );
    }
        ...
        if( $settings['show_category'] == 'yes' ): 
            ...
            ?>
                <div class="portfolio__category">
                   <?php echo esc_html( $this->element_ready_portfolio_category() ); ?>
                </div>
            <?php
            }
        endif;
        ...
        <?php if( $settings['show_author'] == 'yes' || $settings['show_date'] == 'yes'): ?>
            <ul class="portfolio__meta">
                ...
                <?php if( $settings['show_date'] == 'yes' ):?>
                    ...
                    <li><i class="fa fa-clock-o"></i><?php the_time(esc_html__('d F Y','element-ready'));?></li>
                    <?php endif; ?>
            ...
            <div class="portfolio__btn">
                <?php if ( !empty( $settings['readmore_icon'] ) ) : ?>
                    <?php if( 'right'  == $settings['readmore_icon_position'] ) : ?>
                        <a class="readmore__btn" href="<?php the_permalink();?>"><?php echo esc_html__( $settings['read_more_txt'], 'element-ready' );?> <i class="readmore_icon_right <?php echo esc_attr( $settings['readmore_icon'] ) ?>"></i></a>
                    <?php elseif( 'left'  == $settings['readmore_icon_position'] ): ?>
                        <a class="readmore__btn" href="<?php the_permalink();?>"><i class="readmore_icon_left <?php echo esc_attr( $settings['readmore_icon'] ) ?>"></i><?php echo esc_html__( $settings['read_more_txt'], 'element-ready' );?></a>
                    <?php endif; ?>
                <?php else: ?>
                    <a class="readmore__btn" href="<?php the_permalink();?>"><?php echo esc_html__( $settings['read_more_txt'], 'element-ready' );?></a>
                <?php endif; ?>
            </div>
        <?php endif;
    }
