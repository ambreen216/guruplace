...
class Element_Ready_Post_Group_Two extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Post Grid Two', 'element-ready' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Post Content', 'element-ready' ),
            ]
        );
            ...
            $this->add_control(
                'post_masonry',
                [
                    'label'        => esc_html__( 'Post Masonry', 'element-ready' ),
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'element_ready_posts_container_attr', 'class', 'row' );
                    ...
                    ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php if( $query_post->current_post == 1 ) : ?>
                                <div class="col-sm-12 col-md-6 element__ready__right__list__post">
                            <?php endif; ?>
