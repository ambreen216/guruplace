...
class Element_Ready_Data_Table_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Data Table', 'element-ready' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'datatable_layout',
            [
                'label' => esc_html__( 'Table Layout', 'element-ready' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        '3'   => esc_html__( 'Layout Three', 'element-ready' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Show Sorting Options', 'element-ready' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Sorting Options', 'element-ready' ),
                'condition'=>[
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Searching', 'element-ready' ),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => esc_html__( 'Show', 'element-ready' ),
                    'label_off' => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Ordering', 'element-ready' ),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => esc_html__( 'Show', 'element-ready' ),
                    'label_off' => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                'show_datatable_info',
                [
                    'label' => esc_html__( 'Footer Info', 'element-ready' ),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => esc_html__( 'Show', 'element-ready' ),
                    'label_off' => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
        ...
        $this->start_controls_section(
            'datatable_header',
            [
                'label' => esc_html__( 'Table Header', 'element-ready' ),
            ]
        );
        ...
        $repeater = new \Elementor\Repeater();
            ...
            $repeater->add_control(
                'column_name',
                [
                    'label'   => esc_html__( 'Column Name', 'element-ready' ),
                    'type'    => Controls_Manager::TEXT,
                    'default' => esc_html__( 'No', 'element-ready' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'column_name' => esc_html__( 'No', 'element-ready' ),
                        ],

                        [
                            'column_name' => esc_html__( 'Name', 'element-ready' ),
                        ],

                        [
                            'column_name' => esc_html__( 'Designation', 'element-ready' ),
                        ],

                        [
                            'column_name' => esc_html__( 'Email', 'element-ready' ),
                        ]
        ...
        $this->start_controls_section(
            'datatable_content',
            [
                'label' => esc_html__( 'Table Content', 'element-ready' ),
            ]
        );
            ...
            $repeater_one->add_control(
                'field_type',
                [
                    'label' => esc_html__( 'Fild Type', 'element-ready' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'row',
                    'options' => [
                        'row'   => esc_html__( 'Row', 'element-ready' ),
                        'col'   => esc_html__( 'Column', 'element-ready' ),
                    ],
                ]
            );
            ...
            $repeater_one->add_control(
                'cell_text',
                [
                    'label'   => esc_html__( 'Cell Content', 'element-ready' ),
                    'type'    => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Mehedi Hasan', 'element-ready' ),
                    'condition'=>[
                        'field_type'=>'col',
                    ]
                ]
            ...
            $repeater_one->add_control(
                'row_colspan',
                [
                    'label' => esc_html__( 'Colspan', 'element-ready' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'field_type' => esc_html__( 'row', 'element-ready' ),
                        ],

                        [
                            'field_type' => esc_html__( 'col', 'element-ready' ),
                            'cell_text' => esc_html__( '1', 'element-ready' ),
                            'row_colspan' => esc_html__( '1', 'element-ready' ),
                        ],

                        [
                            'field_type' => esc_html__( 'col', 'element-ready' ),
                            'cell_text' => esc_html__( 'Mehedi Hasan', 'element-ready' ),
                            'row_colspan' => esc_html__( '1', 'element-ready' ),
                        ],

                        [
                            'field_type' => esc_html__( 'col', 'element-ready' ),
                            'cell_text' => esc_html__( 'Developer', 'element-ready' ),
                            'row_colspan' => esc_html__( '1', 'element-ready' ),
                        ],
                        ...
                        [
                            'field_type' => esc_html__( 'col', 'element-ready' ),
                            'cell_text' => esc_html__( 'admin@gmail.com', 'element-ready' ),
                            'row_colspan' => esc_html__( '1', 'element-ready' ),
                        ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Table', 'element-ready' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__( 'Table Header Padding', 'element-ready' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Table Body', 'element-ready' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Background Color ( Event )', 'element-ready' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Background Color ( Odd )', 'element-ready' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__( 'Table Body Padding', 'element-ready' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors' => [
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Search label','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Search input','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Header Page wrapper','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Page option text','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Header Page text','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Pagination Link','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Pagination Link Active','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Footer info ','element-ready'),
    ...
    protected function render( $instance = [] ) {
        ...
        <div <?php echo $this->get_render_attribute_string( 'datatable_attr' ); ?>>
            <table class="<?php echo 'element__ready__datatable__'.$id; ?>">
                <?php if( $settings['header_column_list'] ): ?>
                    <thead>
                        <tr>
                            <?php
                                foreach ( $settings['header_column_list'] as $headeritem ) {
                                    echo '<th>'.esc_html__( $headeritem['column_name'],'element-ready' ).'</th>';
                                }
                            ?>
                        </tr>
                    </thead>
