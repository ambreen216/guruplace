...
class Element_Ready_Widget_Video extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'ER Video', 'element-ready' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_video',
			[
				'label' => esc_html__( 'Video', 'element-ready' ),
			]
		);
			...
			$this->add_control(
				'video_type',
				[
					'label'   => esc_html__( 'Source', 'element-ready' ),
					'type'    => Controls_Manager::SELECT,
					'default' => 'youtube',
					'options' => [
						'youtube'     => esc_html__( 'YouTube', 'element-ready' ),
						'vimeo'       => esc_html__( 'Vimeo', 'element-ready' ),
						'dailymotion' => esc_html__( 'Dailymotion', 'element-ready' ),
						'hosted'      => esc_html__( 'Self Hosted', 'element-ready' ),
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'Enter your URL', 'element-ready' ) . ' (YouTube)',
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'Enter your URL', 'element-ready' ) . ' (Vimeo)',
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'Enter your URL', 'element-ready' ) . ' (Dailymotion)',
			...
			$this->add_control(
				'insert_url',
				[
					'label'     => esc_html__( 'External URL', 'element-ready' ),
			...
			$this->add_control(
				'hosted_url',
				[
					'label'   => esc_html__( 'Choose File', 'element-ready' ),
			...
			$this->add_control(
				'external_url',
				[
					'label'         => esc_html__( 'URL', 'element-ready' ),
					...
					'media_type'  => 'video',
					'placeholder' => esc_html__( 'Enter your URL', 'element-ready' ),
					'condition'   => [
						'video_type' => 'hosted',
						'insert_url' => 'yes',
					],
			...
			$this->add_control(
				'start',
				[
					'label'       => esc_html__( 'Start Time', 'element-ready' ),
					'type'        => Controls_Manager::NUMBER,
					'description' => esc_html__( 'Specify a start time (in seconds)', 'element-ready' ),
					'condition'   => [
						'loop' => '',
					],
				]
			...
			$this->add_control(
				'end',
				[
					'label'       => esc_html__( 'End Time', 'element-ready' ),
					'type'        => Controls_Manager::NUMBER,
					'description' => esc_html__( 'Specify an end time (in seconds)', 'element-ready' ),
					'condition'   => [
						'loop'       => '',
			...
			$this->add_control(
				'video_options',
				[
					'label'     => esc_html__( 'Video Options', 'element-ready' ),
			...
			$this->add_control(
				'mute',
				[
					'label' => esc_html__( 'Mute', 'element-ready' ),
					'type'  => Controls_Manager::SWITCHER,
				]
			);
			...
			$this->add_control(
				'controls',
				[
					'label'     => esc_html__( 'Player Controls', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
			...
			$this->add_control(
				'showinfo',
				[
					'label'     => esc_html__( 'Video Info', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'element-ready' ),
					'label_on'  => esc_html__( 'Show', 'element-ready' ),
					'default'   => 'yes',
			...
			$this->add_control(
				'modestbranding',
				[
					'label'     => esc_html__( 'Modest Branding', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'condition' => [
						'video_type' => [ 'youtube' ],
						'controls'   => 'yes',
			...
			$this->add_control(
				'logo',
				[
					'label'     => esc_html__( 'Logo', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'element-ready' ),
					'label_on'  => esc_html__( 'Show', 'element-ready' ),
					'default'   => 'yes',
			...
			$this->add_control(
				'color',
				[
					'label'     => esc_html__( 'Controls Color', 'element-ready' ),
			...
			$this->add_control(
				'yt_privacy',
				[
					'label'       => esc_html__( 'Privacy Mode', 'element-ready' ),
					'type'        => Controls_Manager::SWITCHER,
					'description' => esc_html__( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'element-ready' ),
					'condition'   => [
						'video_type' => 'youtube',
					],
				]
			...
			$this->add_control(
				'rel',
				[
					'label'   => esc_html__( 'Suggested Videos', 'element-ready' ),
					'type'    => Controls_Manager::SELECT,
					'options' => [
						''    => esc_html__( 'Current Video Channel', 'element-ready' ),
						'yes' => esc_html__( 'Any Video', 'element-ready' ),
					],
					'condition' => [
						'video_type' => 'youtube',
					],
			...
			$this->add_control(
				'vimeo_title',
				[
					'label'     => esc_html__( 'Intro Title', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'element-ready' ),
					'label_on'  => esc_html__( 'Show', 'element-ready' ),
					'default'   => 'yes',
			...
			$this->add_control(
				'vimeo_portrait',
				[
					'label'     => esc_html__( 'Intro Portrait', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'element-ready' ),
					'label_on'  => esc_html__( 'Show', 'element-ready' ),
					'default'   => 'yes',
			...
			$this->add_control(
				'vimeo_byline',
				[
					'label'     => esc_html__( 'Intro Byline', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'element-ready' ),
					'label_on'  => esc_html__( 'Show', 'element-ready' ),
					'default'   => 'yes',
			...
			$this->add_control(
				'download_button',
				[
					'label'     => esc_html__( 'Download Button', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'label_off' => esc_html__( 'Hide', 'element-ready' ),
					'label_on'  => esc_html__( 'Show', 'element-ready' ),
					'condition' => [
			...
			$this->add_control(
				'poster',
				[
					'label'     => esc_html__( 'Poster', 'element-ready' ),
					'type'      => Controls_Manager::MEDIA,
					'condition' => [
						'video_type' => 'hosted',
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Image Overlay', 'element-ready' ),
			]
		);
			...
			$this->add_control(
				'image_overlay',
				[
					'label'   => esc_html__( 'Choose Image', 'element-ready' ),
					'type'    => Controls_Manager::MEDIA,
					'default' => [
			...
			$this->add_control(
				'lazy_load',
				[
					'label'     => esc_html__( 'Lazy Load', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'condition' => [
						'show_image_overlay' => 'yes',
						'video_type!'        => 'hosted',
			...
			$this->add_control(
				'show_play_icon',
				[
					'label'     => esc_html__( 'Show Play Icon ?', 'element-ready' ),
					'type'      => Controls_Manager::SWITCHER,
					'default'   => 'yes',
					'condition' => [
						'show_image_overlay'  => 'yes',
			...
			$this->add_control(
				'lightbox',
				[
					'label'              => esc_html__( 'Lightbox', 'element-ready' ),
					'type'               => Controls_Manager::SWITCHER,
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'aspect_ratio',
				[
					'label'   => esc_html__( 'Aspect Ratio', 'element-ready' ),
					'type'    => Controls_Manager::SELECT,
					'options' => [
						'169' => '16:9',
						'219' => '21:9',
		...
		$this->add_control(
			'lightbox_ui_color',
			[
				'label'     => esc_html__( 'UI Color', 'element-ready' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'UI Hover Color', 'element-ready' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Content Width', 'element-ready' ),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'unit' => '%',
				],
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__( 'Content Position', 'element-ready' ),
				'type'               => Controls_Manager::SELECT,
				'frontend_available' => true,
				'options'            => [
					''    => esc_html__( 'Center', 'element-ready' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'              => esc_html__( 'Entrance Animation', 'element-ready' ),
