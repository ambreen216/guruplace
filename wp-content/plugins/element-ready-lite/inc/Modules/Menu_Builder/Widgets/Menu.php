...
class Menu extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Menu', 'element-ready' );
    }
    ...
    public function get_style_depends() {
        ...
        return [
            'element-ready-grid','element-ready-mega-menu-frontend','element-ready-mega-menu-style','stellarnav'
        ];
    }
    public function get_script_depends() {
        return [
            'element-ready-core','element-ready-menu-frontend-script','stellarnav'
        ];
    }
    ...
    public function layout(){
        return[
            ...
            'style2' => esc_html__( 'Offcanvas slide', 'element-ready' ),
            'style3' => esc_html__( 'Standard', 'element-ready' ),
            'style4' => esc_html__( 'Standard round', 'element-ready' ),
            'style5' => esc_html__( 'Standard 5', 'element-ready' ),
            //'style6' => esc_html__( 'Standard box', 'element-ready' ),
            'style7' => esc_html__( 'Standard offcanvas', 'element-ready' ),
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
			'header_logo_section',
			[
                'label'     => esc_html__( 'Header logo', 'element-ready' ),
                'condition' => [
            ...
            $this->add_control(
                'header_logo_type',
                [
                    'label'   => esc_html__( 'Logo Type', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::SELECT,
                    'default' => 'logo',
                    'options' => [
                        'logo' => esc_html__('Image Logo','element-ready'),
                        'text' => esc_html__('Text Logo','element-ready'),
                        'svg'  => esc_html__('SVG Logo','element-ready'),
                    ]
                ]
            );
            $this->add_control(
                'header_logo',
                [
                    'label'   => esc_html__( 'Choose logo', 'element-ready' ),
            ...
            $this->add_control(
                'header_svg_logo',
                [
                    'label'     => esc_html__( 'Svg logo', 'element-ready' ),
            ...
            $this->add_control(
                'header_text_logo',
                [
                    'label'       => esc_html__( 'Text Logo', 'element-ready' ),
                    'type'        => \Elementor\Controls_Manager::TEXT,
                    'default'     => esc_html__( 'Logo', 'element-ready' ),
                    'placeholder' => esc_html__( 'Type your title here', 'element-ready' ),
                ]
            );
        ...
        $this->start_controls_tabs(
            ...
            $this->start_controls_tab(
                'style_main_menu_tab',
                [
                    'label' => esc_html__( 'Main Menu', 'element-ready' ),
                ]
            );
                ...
                $this->add_control(
                    ...
                    [
                        'label'        => esc_html__( 'Mega Menu Content', 'element-ready' ),
                        'type'         => \Elementor\Controls_Manager::SWITCHER,
                        'label_on'     => esc_html__( 'Show', 'element-ready' ),
                        'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                        'return_value' => 'yes',
                ...
                $this->add_control(
                    'enable_meta_content',
                    [
                        'label'        => esc_html__( 'Meta Content', 'element-ready' ),
                        'type'         => \Elementor\Controls_Manager::SWITCHER,
                        'label_on'     => esc_html__( 'Show', 'element-ready' ),
                        'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                        'return_value' => 'yes',
                ...
                $this->add_control(
                    'menu_selected',
                    [
                        'label'   => esc_html__( 'Menu', 'element-ready' ),
                        'type'    => \Elementor\Controls_Manager::SELECT,
                        'default' => '',
                ...
                $this->add_control(
                    'menu_depth',
                    [
                        'label'   => esc_html__( 'Nested Depth', 'element-ready' ),
                ...
                $this->add_control(
                    ...
                    [
                        'label'   => esc_html__( 'Before Item Icons', 'element-ready' ),
                ...
                $this->add_control(
                    'menu_drop_icon',
                    [
                        'label'   => esc_html__( 'After Item Icons', 'element-ready' ),
                        'type'    => \Elementor\Controls_Manager::ICON,
                        'default' => 'fa fa-angle-down',
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        'label'   => esc_html__( 'Submenu Icons', 'element-ready' ),
                        'type'    => \Elementor\Controls_Manager::ICON,
                ...
                $this->add_control(
                    ...
                    [
                        'label'        => esc_html__( 'Extra option', 'element-ready' ),
                ...
                $this->add_control(
                    'wrapper_tag_type',
                        [
                            'label'       => esc_html__( 'Container Tag', 'element-ready' ),
                            'type'        => \Elementor\Controls_Manager::SELECT,
                            'default'     => '',
                            'description' => esc_html__('Menu Main Wrapper container Html tag','element-ready'),
                            'options'     => [
                                ''     => esc_html__( 'none', 'element-ready' ),
                                'div'  => esc_html__( 'div', 'element-ready' ),
                                'p'    => esc_html__( 'p', 'element-ready' ),
                                'span' => esc_html__( 'span', 'element-ready' ),
                                'i'    => esc_html__( 'i', 'element-ready' ),
                                's'    => esc_html__( 's', 'element-ready' ),
                                'b'    => esc_html__( 'b', 'element-ready' ),
                                'p'    => esc_html__( 'P', 'element-ready' ),
                                'ul'   => esc_html__( 'ul', 'element-ready' ),
                            ],
                        ]
                );
                ...
                $this->add_control(
                    'anchore_wrapper_tag_before_type',
                        [
                            'label'       => esc_html__( 'Link Wrapper Before', 'element-ready' ),
                            'type'        => \Elementor\Controls_Manager::SELECT,
                            'default'     => '',
                            'description' => esc_html__('Menu Link Html tag','element-ready'),
                            'options'     => [
                                ''       => esc_html__( 'none', 'element-ready' ),
                                '<div>'  => esc_html__( 'div', 'element-ready' ),
                                '<p>'    => esc_html__( 'p', 'element-ready' ),
                ...
                $this->add_control(
                    'anchore_wrapper_tag_after_type',
                        [
                            'label'   => esc_html__( 'Link Wrapper After', 'element-ready' ),
                            'type'    => \Elementor\Controls_Manager::SELECT,
                            'default' => '',
                            'options' => [
                                ''        => esc_html__( 'none', 'element-ready' ),
                ...
                $this->add_control(
                    'anchore_text_before_tag_type',
                        [
                            'label'   => esc_html__( ' Link Text before', 'element-ready' ),
                            'type'    => \Elementor\Controls_Manager::SELECT,
                            'default' => '',
                            'options' => [
                                ''       => esc_html__( 'none', 'element-ready' ),
                ...
                $this->add_control(
                    'anchore_text_after_tag_type',
                        [
                            'label'   => esc_html__( 'Link Text after', 'element-ready' ),
                            'type'    => \Elementor\Controls_Manager::SELECT,
                            'default' => '',
                            'options' => [
                                ''        => esc_html__( 'none', 'element-ready' ),
                ...
                $this->add_control(
                    ...
                    [
                        'label'        => esc_html__( 'Custom Element Attribute', 'element-ready' ),
                        'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                        'label_off'    => esc_html__( 'Default', 'element-ready' ),
                        'label_on'     => esc_html__( 'Custom', 'element-ready' ),
                        'return_value' => 'yes',
                ...
                $this->start_popover();
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'       => esc_html__( 'Container Class', 'element-ready' ),
                            'type'        => \Elementor\Controls_Manager::TEXT,
                            'default'     => '',
                            'placeholder' => esc_html__( '.custom-container custom-size', 'element-ready' ),
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'       => esc_html__( 'Container Id', 'element-ready' ),
                            'type'        => \Elementor\Controls_Manager::TEXT,
                            'default'     => '',
                            'placeholder' => esc_html__( 'custom-id', 'element-ready' ),
                        ]
                    );
                    ...
                    $this->add_control(
                        'menu_custom_class',
                        [
                            'label'       => esc_html__( 'Menu Class', 'element-ready' ),
                            'type'        => \Elementor\Controls_Manager::TEXT,
                            'default'     => '',
                            'placeholder' => esc_html__( '.menu-custom .type', 'element-ready' ),
                        ]
                    );
                    ...
                    $this->add_control(
                        'menu_custom_id',
                        [
                            'label'       => esc_html__( 'Menu Id', 'element-ready' ),
                            'type'        => \Elementor\Controls_Manager::TEXT,
                            'default'     => '',
                            'placeholder' => esc_html__( 'custom-id', 'element-ready' ),
                        ]
        ...
        $this->start_controls_tab(
            ...
            [
                'label'     => esc_html__( 'OffCanvas', 'element-ready' ),
                'condition' => [
                    'menu_style' => ['style7']
                ]
            ]
            ...
            $this->add_control(
                'offcanvas_enable',
                [
                    'label'        => esc_html__( 'Offcanvas Enable', 'element-ready' ),
                    'type'         => \Elementor\Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'element-ready' ),
                    'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                    'return_value' => 'yes',
    ...
    $this->end_controls_tab();
		...
		$this->start_controls_tab(
			...
			[
                'label'     => esc_html__( 'Mobile Menu', 'element-ready' ),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'Extra Element', 'element-ready' ),
                'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                'label_off'    => esc_html__( 'Default', 'element-ready' ),
                'label_on'     => esc_html__( 'Custom', 'element-ready' ),
                'return_value' => 'yes',
        ...
        $this->start_popover();
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'        => \Elementor\Controls_Manager::TEXT,
                    'default'     => '',
                    'placeholder' => esc_html__( '.prefix-custom-container', 'element-ready' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'        => \Elementor\Controls_Manager::TEXT,
                    'default'     => '',
                    'placeholder' => esc_html__( '.custom-menu-cls .type', 'element-ready' ),
                ]
            );
        ...
        $this->start_controls_section(
			...
			[
                'label'     => esc_html__( 'Header button', 'element-ready' ),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => \Elementor\Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Get Strted', 'element-ready' ),
                'default'     => esc_html__('Get Started','element-ready')
        ...
        $this->start_controls_section(
			...
			[
                'label'     => esc_html__( 'Header Search', 'element-ready' ),
                'condition' => [
                    'menu_style' => ['style74']
                ],
			]
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'Custom _template', 'element-ready' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'element-ready' ),
                'label_off'    => esc_html__( 'Hide', 'element-ready' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'label'       => esc_html__( 'Text', 'element-ready' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Search', 'element-ready' ),
                'default'     => esc_html__('Search','element-ready')
        ...
        $this->box_css( array(
                'title'        => esc_html__('Mega Menu','element-ready'),
        ...
        $this->start_controls_section('Bmain_section',
            [
            'label' => esc_html__( 'Main Section', 'element-ready' ),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'Disable Container', 'element-ready' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'Container Fluid', 'element-ready' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'element-ready' ),
                'label_off'    => esc_html__( 'No', 'element-ready' ),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__( 'Container Width', 'element-ready' ),
    ...
    $this->start_controls_section('Bma_incontainer_section',
        [
        'label'     => esc_html__( 'Menu Container Section', 'element-ready' ),
        'tab'       => Controls_Manager::TAB_STYLE,
        'condition' => [
      ...
      $this->start_controls_section(
        ...
        $this->add_control(
            'style1_offcanvas_float',
                [
                    'label'       => esc_html__( 'Align', 'element-ready' ),
                    'type'        => \Elementor\Controls_Manager::SELECT,
                    'default'     => 'right',
                    'description' => esc_html__('Float left right','element-ready'),
                    'options'     => [
                        ''      => esc_html__( 'none', 'element-ready' ),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'PopUp Box Size', 'element-ready' ),
                'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                'label_off'    => esc_html__( 'Default', 'element-ready' ),
                'label_on'     => esc_html__( 'Custom', 'element-ready' ),
                'return_value' => 'yes',
    ...
    $this->text_css(
        array(
            'title'          => esc_html__('Mobile menu Item Icon','element-ready'),
    ...
    $this->text_wrapper_css(
        array(
            'title'          => esc_html__('Mobile menu close text','element-ready'),
    ...
    $this->text_css(
        array(
            'title'          => esc_html__('Mobile menu close icon','element-ready'),
    ...
    $this->box_css(
        array(
            'title'        => esc_html__('Mobile Menu Item list','element-ready'),
    ...
    $this->text_css(
        array(
            'title'        => esc_html__('Mobile Menu Item text','element-ready'),
    ...
    [
        'label'     => esc_html__( 'Search', 'element-ready' ),
        'tab'       => Controls_Manager::TAB_STYLE,
        'condition' => [
            'menu_style' => ['style7']
        ],
    ...
    $this->add_control(
        ...
        [
            'label'        => esc_html__( 'Icon option', 'element-ready' ),
            'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off'    => esc_html__( 'Default', 'element-ready' ),
            'label_on'     => esc_html__( 'Custom', 'element-ready' ),
            'return_value' => 'yes',
    ...
    $this->add_control(
        ...
        [
            'label'        => esc_html__( 'Container Box', 'element-ready' ),
            'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off'    => esc_html__( 'Default', 'element-ready' ),
            'label_on'     => esc_html__( 'Custom', 'element-ready' ),
            'return_value' => 'yes',
    ...
    $this->add_control(
        '__search_menu_close_icon_bgcolor_', [
            ...
            'label'     => esc_html__( 'Close Color', 'element-ready' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
    ...
    $this->add_control(
        '__search_box_menu_iqwert_icon_bgcolor_', [
            ...
            'label'     => esc_html__( 'Search Color', 'element-ready' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
    ...
    $this->add_control(
        ...
        [
            'label'      => esc_html__( 'Icon Font Size', 'element-ready' ),
            'type'       => Controls_Manager::SLIDER,
    ...
    $this->add_control(
        '__search_box_menu_iqwert_input_color_', [
            ...
            'label'     => esc_html__( 'Input Color', 'element-ready' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
    ...
    $this->add_control(
        '__search_box_menu_iqwert_input_bgcolor_', [
            ...
            'label'     => esc_html__( 'Input Background', 'element-ready' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
    ...
    $this->add_control(
        ...
        [
            'label'        => esc_html__( 'Advanced', 'element-ready' ),
            'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off'    => esc_html__( 'Default', 'element-ready' ),
            'label_on'     => esc_html__( 'Custom', 'element-ready' ),
            'return_value' => 'yes',
    ...
    $this->end_controls_section();
    $this->start_controls_section('menu_item_humberger_mobile_lis_section',
        [
        'label' => esc_html__( 'Mobile Hamburger', 'element-ready' ),
        'tab'   => Controls_Manager::TAB_STYLE,
        ...
        $this->add_control(
            'style2_reverse_menu',
            [
                'label'        => esc_html__( 'Menu Right', 'element-ready' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'element-ready' ),
                'label_off'    => esc_html__( 'No', 'element-ready' ),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__( 'Icon Width', 'element-ready' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range'      => [
                    'px' => [
    ...
    $this->end_controls_section();
        ...
        $this->start_controls_section('menu_item_list_section',
            [
                'label' => esc_html__( 'Nav Item', 'element-ready' ),
                'tab'   => Controls_Manager::TAB_STYLE,
    ...
    $this->start_controls_section('menu_item_lis_section',
        [
            'label' => esc_html__( 'Nav text', 'element-ready' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Before icon', 'element-ready' ),
            ]
        );
                ...
                $this->add_control(
                    ...
                    [
                        'label'     => esc_html__( 'Indicator Icon', 'element-ready' ),
                ...
                $this->add_group_control(
                    ...
                    [
                        ...
                        'label'    => esc_html__( 'Font', 'element-ready' ),
                ...
                $this->start_controls_tab(
                    ...
                    [
                        'label' => esc_html__( 'After icon', 'element-ready' ),
                    ]
                );
                        ...
                        $this->add_control(
                            'menu_item_li_dropdown_after_icon_color', [
                                ...
                                'label'     => esc_html__( 'Dropdown icon Color', 'element-ready' ),
                                'type'      => Controls_Manager::COLOR,
                                'selectors' => [
                        ...
                        $this->add_group_control(
                            ...
                            [
                                ...
                                'label'    => esc_html__( 'Dropdown Arrow', 'element-ready' ),
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Item text', 'element-ready' ),
                    'type'      => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
        ...
        $this->start_controls_tab(
			...
			[
                'label'     => esc_html__( 'Amimated', 'element-ready' ),
                'condition' => [
                    'menu_style' => ['style1']
                ],
			]
        ...
        $this->add_control(
            'animated_menu_item_li_color', [
                ...
                'label'     => esc_html__( 'Animate Color', 'element-ready' ),
                'type'      => Controls_Manager::COLOR,
                'condition' => [
                    'menu_style' => ['style1']
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__( 'Text Typography', 'element-ready' ),
                'condition' => [
                    'menu_style' => ['style1']
                ],
        ...
        $this->add_group_control(
			...
			[
				...
				'label'     => esc_html__( 'Text Shadow', 'element-ready' ),
				'condition' => [
                    'menu_style' => ['style1']
                ],
				'selector' => '{{WRAPPER}} .fsmenu--list-element .fsmenu--scrolling-text span',
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'Menu Pointer', 'element-ready' ),
                'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                'label_off'    => esc_html__( 'Default', 'element-ready' ),
                'label_on'     => esc_html__( 'Custom', 'element-ready' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'element-ready-underline'  => esc_html__( 'Underline', 'element-ready' ),
                    'element-ready-doubleline' => esc_html__( 'Doubleline', 'element-ready' ),
                    'element-ready-background' => esc_html__( 'Background', 'element-ready' ),
                    ''                         => esc_html__( 'None', 'element-ready' ),
                ],
            ]
        );  
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__( 'Hover Pointer Effect', 'element-ready' ),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                   
                    'grow-hover'  => esc_html__( 'Grow', 'element-ready' ),
                    'fade-hover'  => esc_html__( 'Fade', 'element-ready' ),
                    'slide-hover' => esc_html__( 'Slide', 'element-ready' ),
                    ''            => esc_html__( 'None', 'element-ready' ),
                ],
            ]
        ); 
    ...
    $this->start_controls_section('menu_dropdown_sub_item_lis_section',
        [
        'label'     => esc_html__( 'Sub menu Item', 'element-ready' ),
        'tab'       => Controls_Manager::TAB_STYLE,
        'condition' => [
            //'menu_style!' => ['style1']
        ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Dropdown Icon', 'element-ready' ),
                    'type'      => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'menu_style!' => ['style1']
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => esc_html__( 'Dropdown Arrow', 'element-ready' ),
                    'selector' => '{{WRAPPER}} .element-ready-navbar li .sub-menu i ,{{WRAPPER}} .element-ready-navbar li .sub-menu a::after',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .element-ready-navbar li .sub-menu a::after' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .element-ready-navbar li .sub-menu a::after' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        '{{WRAPPER}} .element-ready-navbar li .sub-menu i'        => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__( 'Auto Width', 'element-ready' ),
                    'type'    => \Elementor\Controls_Manager::SELECT,
                    'default' => '',
                    'options' => [
                        'auto' => esc_html('Yes','element-ready'),
                        ''     => esc_html('No','element-ready')
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'      => esc_html__( 'min Width', 'element-ready' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%','vw' ],
                    'range'      => [
                        'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__( 'Text Margin', 'element-ready' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
    ...
    $this->start_controls_section('mobile_menu_content_section',
        [
        'label' => esc_html__( 'Mobile Menu', 'element-ready' ),
        ...
        $this->add_control(
            'mobile_menu_icon',
            [
                'label' => esc_html__( 'Hamburger Icon', 'element-ready' ),
                'type'  => \Elementor\Controls_Manager::ICONS,
        ...
        $this->add_control(
            'mobile_menu_breakpoint',
                [
                    'label'       => esc_html__( 'Menu Breakpoint', 'element-ready' ),
                    'type'        => \Elementor\Controls_Manager::SELECT,
                    'default'     => 'navbar-expand-lg',
                    'description' => esc_html__('Mobile menu breakpoint','element-ready'),
                    'options'     => [
                        ''                 => esc_html__( 'none', 'element-ready' ),
                        'navbar-expand-sm' => esc_html__( 'Small Device', 'element-ready' ),
                        'navbar-expand-md' => esc_html__( 'Medium', 'element-ready' ),
                        'navbar-expand-lg' => esc_html__( 'Large', 'element-ready' ),
                        'navbar-expand-xl' => esc_html__( 'Extra large', 'element-ready' ),
                    ],
                    'condition' => [
    ...
    ?>    
       ...
       <!--====== Header START ======-->
        ...
        <?php if($settings['menu_style'] == 'style3'): ?>
            ...
            <?php $nav_walker_default['menu_list_item_cls'] = 'nav-item '. $settings['enable_mega_menu_content'] =='yes'?'element-ready-mega-menu-item':''; ?>
            <?php $nav_walker_default['sub_menu_ul_cls'] = 'sub-menu element-ready-sub-menu'; ?>
            <?php $args['walker'] = new Offcanvas_Nav_Walker( $nav_walker_default );?>
        ...
        <?php if($settings['menu_style'] == 'style6'): ?>
           
            <?php $nav_walker_default['menu_list_item_cls'] = 'nav-item '. $settings['enable_mega_menu_content'] =='yes'?'element-ready-mega-menu-item':''; ?>
            <?php $nav_walker_default['sub_menu_ul_cls'] = 'sub-menu element-ready-sub-menu'; ?>
            <?php $args['walker'] = new Offcanvas_Nav_Walker( $nav_walker_default );?>
            <?php $args['menu_class'] = $settings['menu_custom_class']==''?'navbar-nav left-menu element-ready--menu--list element-ready-navbar ':'navbar-nav left-menu element-ready--menu--list element-ready-navbar '.$settings['menu_custom_class']; ?>
           
            <?php include('layout/menu/style6.php'); ?>   

        <?php endif; ?>

        <?php if($settings['menu_style'] == 'style7'): ?>
            ...
            <?php $nav_walker_default['sub_menu_ul_cls'] = 'sub-menu element-ready-sub-menu'; ?>
            <?php $args['walker'] = new Offcanvas_Nav_Walker( $nav_walker_default );?>
            <?php $args['menu_class'] = $settings['menu_custom_class']==''?'navbar-nav element-ready--menu--list element-ready-navbar ':'navbar-nav element-ready--menu--list '.$settings['menu_custom_class']; ?>
           
            <?php include('layout/menu/style7.php'); ?>  
