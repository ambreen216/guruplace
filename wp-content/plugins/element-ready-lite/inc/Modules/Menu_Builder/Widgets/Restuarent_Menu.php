...
class Restuarent_Menu extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Round Menu', 'element-ready' );
    }
    ...
    public function get_style_depends() {
        return [
            'element-ready-grid','stellarnav','element-ready-mega-menu-frontend','element-ready-mega-menu-style'
        ];
    }
    public function get_script_depends() {
        return [
            'element-ready-core','stellarnav','element-ready-menu-frontend-script'
        ];
    }
    public function layout(){
        return[
           
            'style9'   => esc_html__( 'Round Menu', 'element-ready' ),
        ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
			...
			[
                'label' => esc_html__( 'Header Position', 'element-ready' ),
                'condition' => [
        ...
        $this->start_controls_section(
			...
			[
                'label' => esc_html__( 'Header Sticky', 'element-ready' ),
                'condition' => [
        ...
        $this->start_controls_tabs(
            ...
            $this->start_controls_tab(
                ...
                $this->add_control(
                    'menu_drop_icon',
                    [
                        'label' => esc_html__( 'Drop Down Icons', 'element-ready' ),
		...
		$this->start_controls_tab(
			...
			[
                'label' => esc_html__( 'Menu 2', 'element-ready' ),
                'condition' => [
                    'menu_style' => ['style8']
                ]
			]
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Menu Wrapper','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Menu Item wrapper','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Menu Item','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Menu Dropdown Item','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Submenu Item Container','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Submenu Wrapper','element-ready'),
        ...
        $this->text_wrapper_css(
            array(
                'title' => esc_html__('Sub Menu Icon','element-ready'),
        ...
        $this->box_css(
            array(
                'title' => esc_html__('Menu Background','element-ready'),
