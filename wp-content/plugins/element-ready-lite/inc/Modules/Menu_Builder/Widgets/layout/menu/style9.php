        ...
        <div class="stricky-header stricked-menu">
            <div class="container">
                <div class="logo-box">
                            ...
                            <?php echo  $settings['header_sticky_logo_type'] == 'text'?'<h1 class="logo-title">':''; ?> 
                                    <a <?php echo $this->get_render_attribute_string( 'header_sticky_logo_warapper' ); ?>>
                                            ...
                                            <?php if( $settings['header_sticky_logo_type'] == 'logo' ): ?>
                                                ...
                                                <?php if( $settings['header_sticky_logo']['url'] !='' ): ?>
                                                    <img src="<?php echo esc_url($settings['header_sticky_logo']['url']); ?>" alt="<?php echo esc_attr__('logo','element-ready'); ?>"/>
                                                <?php endif; ?>
                            ...
                            <?php echo  $settings['header_sticky_logo_type'] == 'text'?'</h1>':''; ?> 
