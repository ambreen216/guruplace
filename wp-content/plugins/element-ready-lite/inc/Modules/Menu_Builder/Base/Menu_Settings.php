...
class Menu_Settings {
    ...
    public function option_popup_views(){
     ...
     public function register_nav_meta_box() {
        ...
        if ( 'nav-menus.php' == $pagenow ) {
            ...
            add_meta_box( 'element-ready-mg-menu-metabox',  esc_html__( 'Mega Menu', 'element-ready' ), array( $this, 'metabox_contents' ), 'nav-menus', 'side', 'default'
            );
    ...
    function create_post(){
        ...
        $mega_menu_post = array(
            'post_title'   => esc_html__('Element Ready menu item','element-ready'),
            'post_content' => '',
            'post_status'  => 'draft',
    ...
    ?>
        <div id="element-ready-mega-menu-metabox">
            ...
            <div class="switch_common">
                <div class="sm_switch">
                    <label><strong><?php esc_html_e( "Enable megamenu?", 'element-ready' ); ?></strong></label>
            ...
            <p> 
                <?php echo get_submit_button( esc_html__('Save', 'element-ready'), 'element-ready-mega-menu-settings-save button-primary alignright','', false); ?>
