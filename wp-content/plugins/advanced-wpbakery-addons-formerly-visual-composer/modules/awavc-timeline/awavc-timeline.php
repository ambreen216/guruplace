...
vc_map( array(
        "name" => __("Timeline", 'awavc'),
        "base" => "timeline",
        "icon" => "awavc_timeline_icon",
        "as_parent" => array('only' => 'timeline_item, timeline_sep'),
    	"category" =>array( __('Advanced Elements', 'awavc'),__('Content', 'awavc')),
        "content_element" => true,
        "show_settings_on_create" => false,
        "description" =>  __('Timeline container', 'awavc'),
        "params" => array(
    array(
      "type" => "dropdown",
      "class" => "",
      "heading" => __("Line type", 'awavc'),
      "param_name" => "type",
    		'save_always' => true,
            "value" => array(
                "Solid" => "solid",	
...
vc_map( array(
        "name" => __("Timeline Item", 'awavc'),
        "base" => "timeline_item",
        "icon" => "awavc_timeline_item",
        "content_element" => true,
        "description" =>  __('Single timeline item', 'awavc'),
        "as_child" => array('only' => 'timeline'), 
        "params" => array(
        array(
          "type" => "dropdown",
          "class" => "",
          "heading" => __("Item position", 'awavc'),
          "param_name" => "position",
        	  'save_always' => true,
                "value" => array(
                    "Right" => "right",	
        ...
        array(
          "type" => "colorpicker",
          "class" => "",
          "heading" => __("Node color", 'awavc'),
          "param_name" => "node_color",
          "description" => "Select color of timeline node"
        ),
        array(
          "type" => "textfield",
          "heading" => __("Date", 'awavc'),
          "param_name" => "date"
        ),
        array(
          "type" => "colorpicker",
          "class" => "",
          "heading" => __("Date background color", 'awavc'),
        ...
        array(
            "type" => "textarea_html",
            "holder" => "div",
            "heading" => __("Content", 'awavc'),
            "param_name" => "content",
            "value" => __("Item content.", 'awavc')
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", 'awavc'),
...
vc_map( array(
        "name" => __("Timeline Seprator", 'awavc'),
        "base" => "timeline_sep",
        "icon" => "awavc_timeline_separator",
        "content_element" => true,
        "description" =>  __('Timeline item separator', 'awavc'),
        "as_child" => array('only' => 'timeline'), 
        "params" => array(
    array(
          "type" => "textfield",
          "heading" => __("Separator text", 'awavc'),
          "param_name" => "sep_text",
          "admin_label" => true,
        ),
    array(
          "type" => "colorpicker",
          "class" => "",
          "heading" => __("Separator background color", 'awavc'),
    ...
    array(
          "type" => "colorpicker",
          "class" => "",
          "heading" => __("Separator text color", 'awavc'),
