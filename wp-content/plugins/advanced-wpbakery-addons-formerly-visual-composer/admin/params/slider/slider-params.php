...
vc_add_shortcode_param( 'prime_slider', 'AWAVC_slider_range_function', AWAVC_URL . '/admin/params/slider/js/slider-params.js');
function AWAVC_slider_range_function( $settings, $value ) {
	$defaults = array(
		'min'        => 0,
		'max'        => 100,
		'step'       => 1,
